...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		// Get the player to enter an adjective
		 String adjective = JOptionPane.showInputDialog("Insert an adgetive");
		// Get the player to enter a type of liquid
		 String liquid = JOptionPane.showInputDialog("Insert a liquid");
		// Get the player to enter a body part
		 String bodypart = JOptionPane.showInputDialog("Insert a bodypart");
		...
		JOptionPane.showMessageDialog(null,prompt+story);
